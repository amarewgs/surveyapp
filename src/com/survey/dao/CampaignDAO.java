...
/**
 * A data access object (DAO) providing persistence and search support for Campaign
 ...
 * 
 * @see com.survey.hibernate.model.Campaign
...
public class CampaignDAO extends HibernateDaoSupport {
	...
	public Campaign findById(java.lang.Integer id) {
		...
		try {
			Campaign instance = (Campaign) getHibernateTemplate().get(
					"com.survey.hibernate.model.Campaign", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByCampaignDate(Object campaignDate) {
		return findByProperty(CAMPAIGN_DATE, campaignDate);
	}
	...
	public Campaign merge(Campaign detachedInstance) {
		...
		try {
			Campaign result = (Campaign) getHibernateTemplate().merge(
					detachedInstance);

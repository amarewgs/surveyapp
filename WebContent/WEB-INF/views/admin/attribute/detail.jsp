						...
						<div class="box" style="display: inline-block;">
							<div class="box-header">
								...
								<div style="float: right;">
									<a href="<spring:url value="/admin/attribute/list" htmlEscape="true" />" class="btn btn-small btn-remove">
			                            <i class="btn-icon-only icon-remove"></i>
			                        </a>
									<a id="delete_link" data-href="<spring:url value="/admin/attribute/delete/${attribute.id }" htmlEscape="true" />" data-toggle="modal" onclick="openDeleteDialog(this)" class="btn btn-small trash">
							...
							<div class="box-content">
								<div class="form form-horizontal" style="display: inline-block; margin-bottom: 4px; width: 90%; vertical-align: top;">
									...
									<div class="control-group " style="width: 100%;display: inline-block; margin-bottom: 0;">
										...
										<div class="" style="display: inline-block; width: 50%; float: none;">
											<label class="span4" style="">${attribute.active ? 'Yes' : 'No'}</label>
										</div>
									</div>
									<div class="control-group " style="width: 100%;display: inline-block; margin-bottom: 0;">
										<label style="width: 15%; display: inline-block; vertical-align: top; margin-bottom: 0" class="control-label">Field Type</label> 
										<div class="" style="display: inline-block; width: 50%; float: none;">
											<label class="span4" style="">${attribute.fieldType}</label>
										</div>
									</div>
								</div>
							</div>

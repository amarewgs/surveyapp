						...
						<div class="box" style="display: inline-block;">
							<div class="box-header">
								...
								<div style="float: right;">
									<a href="<spring:url value="/admin/template/list" htmlEscape="true" />" class="btn btn-small btn-remove">
			                            <i class="btn-icon-only icon-remove"></i>
			                        </a>
									<a id="delete_link" data-href="<spring:url value="/admin/template/delete/${template.templateId }" htmlEscape="true" />" data-toggle="modal" onclick="openDeleteDialog(this)" class="btn btn-small trash">
			                            <i class="btn-icon-only icon-trash"></i>
			                        </a>									
			                        <a href="<spring:url value="/admin/assetType/form/${template.templateId }" htmlEscape="true" />" class="btn btn-small btn-edit">
